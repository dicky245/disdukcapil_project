...
<aside class="sidebar fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 z-50 shadow-lg">
    ...
    <nav class="p-4 space-y-1 overflow-y-auto h-[calc(100vh-4rem)]">
        <a href="{{ route('keagamaan.dashboard') }}" class="sidebar-link {{ request()->routeIs('keagamaan.dashboard') ? 'active' : '' }} flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700">
        ...
        <a href="{{ route('keagamaan.antrian_kalender') }}" class="sidebar-link {{ request()->routeIs('keagamaan.antrian_kalender') ? 'active' : '' }} flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700">
            <i class="fas fa-calendar-alt w-5"></i>
            <span class="sidebar-text font-medium">Antrian & Kalender</span>
        </a>
        <a href="{{ route('keagamaan.sinkronisasi_dukcapil') }}" class="sidebar-link {{ request()->routeIs('keagamaan.sinkronisasi_dukcapil') ? 'active' : '' }} flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700">
            <i class="fas fa-sync w-5"></i>
            <span class="sidebar-text font-medium">Sinkronisasi Dukcapil</span>
        </a>
        <a href="{{ route('keagamaan.manajemen_dokumen') }}" class="sidebar-link {{ request()->routeIs('keagamaan.manajemen_dokumen') ? 'active' : '' }} flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700">
            <i class="fas fa-file-alt w-5"></i>
            <span class="sidebar-text font-medium">Manajemen Dokumen</span>
        </a>
        <a href="{{ route('keagamaan.lacak_berkas') }}" class="sidebar-link {{ request()->routeIs('keagamaan.lacak_berkas') ? 'active' : '' }} flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700">
