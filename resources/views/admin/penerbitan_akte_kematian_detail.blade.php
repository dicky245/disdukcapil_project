        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-blue-800 font-medium leading-relaxed">
                    Semua rincian jenazah, saksi, dan pelapor tersedia secara lengkap pada dokumen <span class="font-bold">"Formulir F-2.01"</span> yang diunggah oleh pemohon.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 h-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="border border-gray-200 rounded-xl p-4 flex flex-col justify-between hover:shadow-md transition-all bg-gray-50/50">
                        ...
                        @if($berkas->{$dok['field']})
                            {{-- MENGGUNAKAN ROUTE SPESIFIK UNTUK AKTE KEMATIAN --}}
                            <a href="{{ route('admin.akte-kematian.lihat-berkas', ['uuid' => $berkas->uuid, 'field' => $dok['field']]) }}" target="_blank"
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mt-6">
                ...
                <div class="flex items-center gap-6">
                    {{-- MENGGUNAKAN ROUTE SPESIFIK UNTUK FOTO AKTE KEMATIAN --}}
                    <img 
                        src="{{ route('admin.akte-kematian.lihat-berkas', ['uuid' => $berkas->uuid, 'field' => 'foto_wajah']) }}"
