...
<div class="container-fluid p-6 bg-gray-50 min-h-screen">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-slate-800">
            Kelola Penerbitan Kartu Keluarga
        </h1>
    </div>
    ...
    <form method="GET">
        <div class="bg-white p-4 rounded-xl shadow-sm border mb-6 flex items-center gap-4">
        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-blue-700 text-white">
                    <th class="p-4 text-xs uppercase">No</th>
                    <th class="p-4 text-xs uppercase">Nama Pemohon</th>
                    <th class="p-4 text-xs uppercase">Alamat</th>
                    <th class="p-4 text-xs uppercase text-center">Status</th>
                    <th class="p-4 text-xs uppercase text-center">Aksi</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="p-4 text-center">
                        <span class="bg-orange-50 text-orange-600 px-3 py-1 rounded-full text-xs font-bold border">
                            {{ $data->status }}
                        </span>
                    </td>
                    <td class="p-4">
