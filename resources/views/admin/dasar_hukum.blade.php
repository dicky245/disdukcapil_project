...
<div class="container-fluid p-6">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800"><i class="fas fa-balance-scale mr-2"></i>Dasar Hukum</h1>
        <p class="text-gray-600 mt-1">Dasar hukum pelayanan administrasi kependudukan</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-8">
        <div class="text-center py-12">
            ...
            <p class="text-gray-600 mb-6">Halaman dasar hukum sedang dalam pengembangan.</p>
