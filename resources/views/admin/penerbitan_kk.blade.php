                    ...
                    <td class="p-4 text-center">
                        <div class="flex flex-col gap-2 items-center">
                            <a href="{{ route('admin.detail', ['uuid' => $data->uuid, 'jenis' => $data->jenis]) }}"
                               class="w-28 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-3 py-1 rounded text-xs transition">
                               Detail
                            </a>
...
@push('scripts')
<script>
// Perbaikan Event Handling untuk SweetAlert
