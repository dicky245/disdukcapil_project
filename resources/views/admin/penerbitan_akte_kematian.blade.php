                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="p-4">
                        <div class="flex flex-col gap-1 items-center">
                            ...
                            class="w-28 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-3 py-1 rounded-lg text-xs font-semibold text-center">
                                Cek Berkas
                            </a>
