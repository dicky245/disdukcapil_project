    ...
    <div class="space-y-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow border">
            ...
            <div class="grid md:grid-cols-3 gap-3 text-sm">
                ...
                <a href="{{ asset('storage/'.$berkas->file_surat_lahir) }}" target="_blank" class="bg-gradient-to-r from-green-600 to-green-700 text-white p-2 rounded text-center hover:from-green-700 hover:to-green-800 transition">
                    Surat Kelahiran
                </a>

                <a href="{{ asset('storage/'.$berkas->file_buku_nikah) }}" target="_blank" class="bg-gradient-to-r from-green-600 to-green-700 text-white p-2 rounded text-center hover:from-green-700 hover:to-green-800 transition">
                    Buku Nikah
                </a>

                <a href="{{ asset('storage/'.$berkas->file_kk) }}" target="_blank" class="bg-gradient-to-r from-green-600 to-green-700 text-white p-2 rounded text-center hover:from-green-700 hover:to-green-800 transition">
                    Kartu Keluarga
                </a>
