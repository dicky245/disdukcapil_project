...
<div class="container-fluid p-6">
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Kelola berita dan informasi terkait layanan kependudukan</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-8">
        <div class="text-center py-12">
            ...
            <p class="text-gray-600 mb-6">Halaman kelola berita sedang dalam pengembangan.</p>
