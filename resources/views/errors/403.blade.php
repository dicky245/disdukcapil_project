    ...
    <div class="relative z-10 max-w-2xl w-full mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12 mb-8">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="{{ route('login') }}" class="flex-1 px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-bold hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg flex items-center justify-center gap-2">
